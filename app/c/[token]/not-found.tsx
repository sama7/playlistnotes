...
/**
 * What someone sees when a shared collection's link no longer works.
 *
...
export default function SharedCollectionNotFound() {
  return (
    <main>
      ...
      <p className="lede">
        Either it was never a link, or the person who shared it has made their collection
        private again. Collections on TrackJot are private by default, and sharing can
